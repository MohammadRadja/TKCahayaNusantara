    ...
    <div class="container pt-4">
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-3">
                ...
                <div>
                    Taman Kanak-kanak (TK) Cahaya Nusantara yang beralamat di
                    Perumahan Grand Argo Subur Blok A5 No. 27 Jl. Raya Kp. Cibogo Desa
                    Pasanggrahan Kec. Solear Kab. Tangerang Provinsi Banten.
                </div>
            </div>
